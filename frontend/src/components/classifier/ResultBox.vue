      ...
      <div v-else-if="state === 'result'" key="result" class="w-full">
        <Transition name="pop" appear>
          <div>
            ...
            <!-- Indonesian label -->
            <div class="text-[24px] font-extrabold text-primary text-center mb-1">
              {{ resultLabel }}
            </div>
            <div class="text-xs text-secondary/30 text-center mb-6 font-mono">
              {{ predictedClass }}
            </div>
          </div>
        </Transition>
